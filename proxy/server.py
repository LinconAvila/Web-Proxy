...
def create_app():
    ...
    def proxy(url):
        ...
        if is_blocked(url):
            ...
            return app.send_static_file("blocked.html"), 403
        ...
        filtered_html, already_filtered = filter_content(response.text)

        action = "filtered" if already_filtered else "allowed"
